define([],function () {
    ...
    MED.origin = function () {
        ...
        ENV.iOS && (methods = {
            ...
            //ios 内购
            iosbuy:function(pid,pnum){
                return NativeBridge.call('iosbuy',arrayOf(arguments),dummy());
            },
            navigator: {
                accelerometer: {
    ...
    MED.iosbuy=function(pid,pNum){
        return MED.origin.iosbuy(pid,pNum);
    }
    //摇一摇业务封装
